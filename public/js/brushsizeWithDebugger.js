...
var _lucamug$coach_a_test$BrushSize$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _lucamug$coach_a_test$BrushSize$brushChange = _elm_lang$core$Native_Platform.outgoingPort(
	'brushChange',
	function (v) {
		return v;
	});
var _lucamug$coach_a_test$BrushSize$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Increment') {
			return {
				ctor: '_Tuple2',
				_0: model + 1,
				_1: _lucamug$coach_a_test$BrushSize$brushChange(model + 1)
			};
		} else {
			return {
				ctor: '_Tuple2',
...
var _lucamug$coach_a_test$BrushSize$Decrement = {ctor: 'Decrement'};
var _lucamug$coach_a_test$BrushSize$Increment = {ctor: 'Increment'};
var _lucamug$coach_a_test$BrushSize$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('brushsize'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Brush size'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(_lucamug$coach_a_test$BrushSize$Decrement),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_lucamug$coach_a_test$BrushSize$Increment),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
...
var _lucamug$coach_a_test$BrushSize$main = _elm_lang$html$Html$program(
	{
		init: {ctor: '_Tuple2', _0: 3, _1: _elm_lang$core$Platform_Cmd$none},
		view: _lucamug$coach_a_test$BrushSize$view,
		update: _lucamug$coach_a_test$BrushSize$update,
		subscriptions: _lucamug$coach_a_test$BrushSize$subscriptions
	})();

var Elm = {};
Elm['BrushSize'] = Elm['BrushSize'] || {};
if (typeof _lucamug$coach_a_test$BrushSize$main !== 'undefined') {
    _lucamug$coach_a_test$BrushSize$main(Elm['BrushSize'], 'BrushSize', {"types":{"unions":{"BrushSize.Msg":{"args":[],"tags":{"Decrement":[],"Increment":[]}}},"aliases":{},"message":"BrushSize.Msg"},"versions":{"elm":"0.18.0"}});
}
